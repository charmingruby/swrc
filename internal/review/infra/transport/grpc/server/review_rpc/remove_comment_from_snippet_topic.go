...
func (h *ReviewGRPCService) RemoveCommentFromSnippetTopic(ctx context.Context, req *pb.RemoveCommentFromSnippetTopicRequest) (*emptypb.Empty, error) {
	...
	input := dto.RemoveCommentFromSnippetTopicInputDTO{
		CommentID: req.CommentVoteId,
		AccountID: accountID,
	}

	if err := h.reviewService.RemoveCommentFromSnippetTopicUseCase(input); err != nil {
