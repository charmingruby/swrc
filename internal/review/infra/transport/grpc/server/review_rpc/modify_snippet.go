...
func (h *ReviewGRPCService) ModifySnippet(ctx context.Context, req *pb.ModifySnippetRequest) (*emptypb.Empty, error) {
	...
	if err := h.reviewService.ModifySnippetUseCase(input); err != nil {
