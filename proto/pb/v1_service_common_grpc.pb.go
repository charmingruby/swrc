...
func (c *commonClient) HealthCheck(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckReply, error) {
	out := new(HealthCheckReply)
	err := c.cc.Invoke(ctx, "/proto.Common/HealthCheck", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCommonServer) HealthCheck(context.Context, *HealthCheckRequest) (*HealthCheckReply, error) {
...
func _Common_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Common/HealthCheck",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommonServer).HealthCheck(ctx, req.(*HealthCheckRequest))
	}
...
var Common_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "v1_service_common.proto",
}
