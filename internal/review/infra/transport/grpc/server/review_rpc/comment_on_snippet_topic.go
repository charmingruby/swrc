...
func (h *ReviewGRPCService) CommentOnSnippetTopic(ctx context.Context, req *pb.CommentOnSnippetTopicRequest) (*emptypb.Empty, error) {
	...
	if err := h.reviewService.CommentOnSnippetTopicUseCase(input); err != nil {
