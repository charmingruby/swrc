...
// 	protoc        v3.14.0
// source: v1_rpc_health_check.proto
...
var (
	file_v1_rpc_health_check_proto_rawDescOnce sync.Once
	file_v1_rpc_health_check_proto_rawDescData = file_v1_rpc_health_check_proto_rawDesc
)

func file_v1_rpc_health_check_proto_rawDescGZIP() []byte {
	file_v1_rpc_health_check_proto_rawDescOnce.Do(func() {
		file_v1_rpc_health_check_proto_rawDescData = protoimpl.X.CompressGZIP(file_v1_rpc_health_check_proto_rawDescData)
	})
...
func init() { file_v1_rpc_health_check_proto_init() }
func file_v1_rpc_health_check_proto_init() {
	if File_v1_rpc_health_check_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_v1_rpc_health_check_proto_goTypes,
		DependencyIndexes: file_v1_rpc_health_check_proto_depIdxs,
		MessageInfos:      file_v1_rpc_health_check_proto_msgTypes,
	}.Build()
	File_v1_rpc_health_check_proto = out.File
	file_v1_rpc_health_check_proto_rawDesc = nil
	file_v1_rpc_health_check_proto_goTypes = nil
	file_v1_rpc_health_check_proto_depIdxs = nil
}
